 ...
 * @Package: com.hrh.web.socket.service
 * @ClassName: WebSocketServer
 * @Author: break
 * @Description:
 * @Date: 2019/6/10 0010 下午 15:08
 * @Version: 1.0
 */
...
public class WebSocketServer {
    ...
    public void onOpen(Session session, @PathParam("userId") String username) {
        ...
        System.out.println(username+"加入！当前在线人数为" + getOnlineCount());
        try {
    ...
    public void onClose() {
        ...
        System.out.println("一个连接关闭！当前在线人数为" + getOnlineCount());
    }
